#ifndef SRCS_INCS_HTTPREQUESTDTO_HPP_
#define SRCS_INCS_HTTPREQUESTDTO_HPP_
#include <map>
#include <string>
...
class HttpRequestDTO {
	...
	private:
		...
		HttpRequestDTO &	operator=(const HttpRequestDTO &);

		std::size_t	ParseRawString_(const std::string &raw_request);
